...
double getCompensationRad_xyResistance(double target_x,double target_y,double velocity_0,bool log_flag=false,int N_times=10,double g=9.7803,double k_1=0.1);
